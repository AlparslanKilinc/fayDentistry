        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" sx={{ mb: 3, maxWidth: '90%' }}>
              Our goal is to promote oral wellness, deliver exquisitely crafted quality dentistry, and provide personalized care. We aim to be at the forefront of dental knowledge and technology.
            </Typography>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Stack spacing={2.5}>
              <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                <LocationOnIcon sx={{ color: theme.palette.primary.main, mr: 1.5, mt: 0.3 }} />
        ...
        <Container maxWidth="xl">
          ...
          >
            <Typography variant="body2" color="grey.500">
              Copyright ©{new Date().getFullYear()} Dr. Terese N. Fay, DMD, PLLC. All rights reserved
            </Typography>
